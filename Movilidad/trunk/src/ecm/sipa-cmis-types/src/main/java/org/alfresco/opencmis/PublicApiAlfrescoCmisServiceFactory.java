...
public class PublicApiAlfrescoCmisServiceFactory extends AlfrescoCmisServiceFactory
{
    ...
    public void setCustomModels(CustomModels customModels) { this.customModels = customModels; }
    ...
    {
        return new PublicApiAlfrescoCmisService(connector, tenantAdminService, networksService, customModels, customModelService);
    }
}
