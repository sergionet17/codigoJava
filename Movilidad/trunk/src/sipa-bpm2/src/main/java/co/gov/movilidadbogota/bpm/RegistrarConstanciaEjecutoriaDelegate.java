...
@Component
public class RegistrarConstanciaEjecutoriaDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        CommandContext ret = sipaServicesClient.getComparendos().generarConstanciaEjecutoriaAutomatica(
