...
@Component
public class RegistrarResolucionFalloDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        CommandContext ret = sipaServicesClient.getComparendos().generarResolucionAutomaticaFallo(
