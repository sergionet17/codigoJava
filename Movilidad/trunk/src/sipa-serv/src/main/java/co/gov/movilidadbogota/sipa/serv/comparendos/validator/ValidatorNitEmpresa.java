 ...
 */
@Component
public class ValidatorNitEmpresa extends ValidatorFiledEmpty implements ValidatorField {


    @Override
    public void validar(FormatoComparendo formatoComparendo, MapBindingResult errors, ComparendoDto comparendoDto) {
        super.setNameField("nitEmpresa");
        super.setField(formatoComparendo.getNitEmpresa());
        super.validatorField(formatoComparendo, errors,
                "El NIT de la empresa debe ser obligatorio", "fmt.nitEmpresa.invalid");
    }
}
