...
/**
 * Se encarga de pasar los datos del comparendo al contexto que requiere el proceso que inicia la resolución automática de fallo.
 *
 * @author maria.rodriguez
 */
@Component
public class ResolucionAutomaticaExtractor implements Command {
