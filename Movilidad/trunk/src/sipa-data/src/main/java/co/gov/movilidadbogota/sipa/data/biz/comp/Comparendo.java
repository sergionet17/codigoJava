...
public class Comparendo {
    ...
    @ManyToOne
    private TipoProcesoContravencional tipoProcesoContravencional;
    ...
    public VolantePago getVolantePago() {
        return volantePago;
    }

    public void setVolantePago(VolantePago volantePago) {
        this.volantePago = volantePago;
    }

    public TipoProcesoContravencional getTipoProcesoContravencional() {
        return tipoProcesoContravencional;
    }

    public void setTipoProcesoContravencional(TipoProcesoContravencional tipoProcesoContravencional) {
        this.tipoProcesoContravencional = tipoProcesoContravencional;
    }
