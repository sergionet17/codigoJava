 ...
 */
@Component
public class StrategyConstanciaEjecutoriaMultaTransportePublico extends TransaccionStrategyAdapter {
    @Override
    public void buildEntradas(Transaccion tx) {
        ...
        tx.with(Cuenta.ACT_TRANSPORTE_PUBLICO).debito(saldoOrden);
        tx.with(Cuenta.ING_TRANSPORTE_PUBLICO).credito(saldoOrden);
