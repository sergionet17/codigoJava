...
public class ComparendoServiceImpl implements ComparendoService {
    ...
    public CommandContext generarResolucionAutomaticaFallo(UUID comparendoId, CommandContext commandContext) throws ComparendoException {
        ...
        if (comparendo == null) {
            throw new ComparendoException("No se encontró el comparendo " + comparendoId.toString());
        }
        ...
        if (oldRaf != null)
            throw new ComparendoException("Ya se encuentra generada una resolución automática de fallo para el comparendo " + comparendoId.toString());
        ...
        if (resolucion == null)
            throw new ComparendoException("No se encontró el documento resolución para el comparendo " + comparendoId.toString());
        ...
        try {
            ...
            throw new ComparendoException(String.format(
    ...
    public CommandContext generarConstanciaEjecutoriaAutomatica(UUID comparendoId, CommandContext commandContext) throws ComparendoException {
        ...
        if (oldCea != null)
            throw new ComparendoException("Ya se encuentra generada una constancia ejecutoria para el comparendo");
