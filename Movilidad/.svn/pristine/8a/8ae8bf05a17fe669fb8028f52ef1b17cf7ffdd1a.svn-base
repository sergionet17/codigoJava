            ...
            <div class="panel-body">
                 ...
                 <div class="col-md-6">
                    <div class="form-group sipa-m-3-r">
                        <label for="tipoPrueba">Tipo Prueba</label>
                        <@s.formSingleSelect path="comparendo.tipoPruebaProcesoContravencional.id" options=tipoPruebaMap attributes="class='form-control' id='tipoPrueba'" />
                    </div>
                </div>
                  <div class="col-md-6">
                    <div class="form-group sipa-m-3-l">
                        <label>¿Otro?</label>
                        <@l.inputText name="otros" class="form-control" size="40" />
                    </div>
                </div>  
