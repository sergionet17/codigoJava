...
/**
 * Representa la información relativa a la generación de un documento de resolución de fallo
 *
 * @author maria.rodriguez
 */
@Entity
public class ResolucionAutomaticaDeFallo {

    public ResolucionAutomaticaDeFallo() {
    }

    public ResolucionAutomaticaDeFallo(String numero){
        this.numero = numero;
    }
